...
- **Historial editable**: cada entrada tiene un botón "Editar" para
  cambiar la calificación o el comentario de cualquier día pasado.
...
- **Reiniciar progreso**: en Stats, borra todo el historial local y
  vuelve a arrancar en el Día 1 (con confirmación, no se puede deshacer).
